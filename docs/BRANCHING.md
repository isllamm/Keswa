...
`dev` sits at the end of Phase 5; `prod` is still at Phase 4. Nothing has been installed in a shop
...
Historical phase branches (`feature/phase-0-scaffold` … `feature/phase-5-sell`) point at the commit
